...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/vyper-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11989&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/vyper-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `vyper` can be installed with:

```
conda install vyper
```

It is possible to list all of the versions of `vyper` available on your platform with:
